...
TEST_CASE("[TestSimpleParser] Multiple procedures - Direct calls", "[SimpleParser][Procedures]") {
  ...
  REQUIRE(callProcTable.contains({ 2, pkb.getIntRefFromEntity("b") }));
  REQUIRE(callProcTable.contains({ 3, pkb.getIntRefFromEntity("c") }));
  ...
  REQUIRE(modifiesPTable.size() == 2);
  REQUIRE(modifiesSTable.contains({ 1, pkb.getIntRefFromEntity("x") }));
  REQUIRE(modifiesSTable.contains({ 4, pkb.getIntRefFromEntity("y") }));
  REQUIRE(modifiesSTable.size() == 2);
  REQUIRE(usesPTable.contains({ pkb.getIntRefFromEntity("c"), pkb.getIntRefFromEntity("z") }));
  REQUIRE(usesPTable.size() == 1);
  REQUIRE(usesSTable.contains({ 5, pkb.getIntRefFromEntity("z") }));
  ...
  SECTION("Transitive") {
    ...
    REQUIRE(modifiesSTable.contains({ 2, pkb.getIntRefFromEntity("y") }));
    ...
    REQUIRE(usesSTable.contains({ 3, pkb.getIntRefFromEntity("z") }));
...
TEST_CASE("[TestSimpleParser] Multiple procedures - Indirect calls", "[SimpleParser][Procedures]") {
  ...
  REQUIRE(callProcTable.contains({ 2, pkb.getIntRefFromEntity("b") }));
  REQUIRE(callProcTable.contains({ 4, pkb.getIntRefFromEntity("c") }));
  REQUIRE(callProcTable.size() == 2);
  REQUIRE(callsTable.contains({ pkb.getIntRefFromEntity("a"), pkb.getIntRefFromEntity("b") }));
  ...
  REQUIRE(modifiesPTable.size() == 3);
  REQUIRE(modifiesSTable.contains({ 1, pkb.getIntRefFromEntity("x") }));
  REQUIRE(modifiesSTable.contains({ 3, pkb.getIntRefFromEntity("y") }));
  REQUIRE(modifiesSTable.contains({ 5, pkb.getIntRefFromEntity("w") }));
  REQUIRE(modifiesSTable.size() == 3);
  REQUIRE(usesPTable.contains({ pkb.getIntRefFromEntity("b"), pkb.getIntRefFromEntity("v") }));
  REQUIRE(usesPTable.contains({ pkb.getIntRefFromEntity("c"), pkb.getIntRefFromEntity("z") }));
  REQUIRE(usesPTable.size() == 2);
  REQUIRE(usesSTable.contains({ 3, pkb.getIntRefFromEntity("v") }));
  REQUIRE(usesSTable.contains({ 5, pkb.getIntRefFromEntity("z") }));
  REQUIRE(usesSTable.size() == 2);
  ...
  SECTION("Transitive") {
    ...
    REQUIRE(modifiesSTable.contains({ 2, pkb.getIntRefFromEntity("y") }));
    REQUIRE(modifiesSTable.contains({ 2, pkb.getIntRefFromEntity("w") }));
    REQUIRE(modifiesSTable.contains({ 4, pkb.getIntRefFromEntity("w") }));
    ...
    REQUIRE(usesSTable.contains({ 2, pkb.getIntRefFromEntity("v") }));
    REQUIRE(usesSTable.contains({ 2, pkb.getIntRefFromEntity("z") }));
    REQUIRE(usesSTable.contains({ 4, pkb.getIntRefFromEntity("z") }));
...
TEST_CASE("[TestSimpleParser] Valid read statement", "[SimpleParser][Read]") {
  ...
  REQUIRE(modifiesSTable.contains({ 1, pkb.getIntRefFromEntity("s3s1kd03kd42d") }));
...
TEST_CASE("[TestSimpleParser] Valid print statement", "[SimpleParser][Print]") {
  ...
  REQUIRE(varTable.size() == 1);
  REQUIRE(stmtTable.size() == 1); 
  REQUIRE(usesSTable.contains({ 1, pkb.getIntRefFromEntity("s3s1kd03kd42d") }));
  REQUIRE(usesSTable.size() == 1);
}
...
TEST_CASE("[TestSimpleParser] Valid assign statement - Basic", "[SimpleParser][Assign]") {
  SECTION("Single variable") {
    ...
    REQUIRE(stmtTable.size() == 1); 
    REQUIRE(usesSTable.contains({ 1, pkb.getIntRefFromEntity("y") }));
    REQUIRE(usesSTable.size() == 1);
    REQUIRE(modifiesSTable.contains({ 1, pkb.getIntRefFromEntity("x") }));
    REQUIRE(modifiesSTable.size() == 1);
    REQUIRE(patternAssignTable.contains({ 1, pkb.getIntRefFromEntity("x"), pkb.getIntRefFromEntity(expectedPostFixString) }));
  ...
  SECTION("Multiple assign") {
    ...
    REQUIRE(patternAssignTable.contains({ 1, pkb.getIntRefFromEntity("x"), pkb.getIntRefFromEntity(expectedPostFixString1) }));
    REQUIRE(patternAssignTable.contains({ 2, pkb.getIntRefFromEntity("y"), pkb.getIntRefFromEntity(expectedPostFixString2) }));
...
TEST_CASE("[TestSimpleParser] Valid assign statement - Advanced", "[SimpleParser][Assign]") {
  SECTION("Geekforgeeks example") {
    ...
    REQUIRE(stmtTable.size() == 1); 
    REQUIRE(usesSTable.contains({ 1, pkb.getIntRefFromEntity("a") }));
    REQUIRE(usesSTable.contains({ 1, pkb.getIntRefFromEntity("b") }));
    REQUIRE(usesSTable.contains({ 1, pkb.getIntRefFromEntity("c") }));
    REQUIRE(usesSTable.contains({ 1, pkb.getIntRefFromEntity("d") }));
    REQUIRE(usesSTable.contains({ 1, pkb.getIntRefFromEntity("e") }));
    REQUIRE(usesSTable.contains({ 1, pkb.getIntRefFromEntity("f") }));
    REQUIRE(usesSTable.contains({ 1, pkb.getIntRefFromEntity("g") }));
    REQUIRE(usesSTable.contains({ 1, pkb.getIntRefFromEntity("h") }));
    REQUIRE(usesSTable.contains({ 1, pkb.getIntRefFromEntity("i") }));
    REQUIRE(usesSTable.size() == 9);
    REQUIRE(modifiesSTable.contains({ 1, pkb.getIntRefFromEntity("z") }));
    REQUIRE(modifiesSTable.size() == 1);
    REQUIRE(patternAssignTable.contains({ 1, pkb.getIntRefFromEntity("z"), pkb.getIntRefFromEntity(expectedPostFixString) }));
    REQUIRE(patternAssignTable.size() == 1);
  }
  ...
  SECTION("Geeksforgeeks comment example") {
    ...
    REQUIRE(stmtTable.size() == 1); 
    REQUIRE(usesSTable.contains({ 1, pkb.getIntRefFromEntity("var1340") }));
    REQUIRE(usesSTable.contains({ 1, pkb.getIntRefFromEntity("varY") }));
    REQUIRE(usesSTable.contains({ 1, pkb.getIntRefFromEntity("varZ") }));
    REQUIRE(usesSTable.contains({ 1, pkb.getIntRefFromEntity("v13dj3d0a3kd") }));
    REQUIRE(usesSTable.size() == 4);
    REQUIRE(modifiesSTable.contains({ 1, pkb.getIntRefFromEntity("c") }));
    REQUIRE(modifiesSTable.size() == 1);
    REQUIRE(patternAssignTable.contains({ 1, pkb.getIntRefFromEntity("c"), pkb.getIntRefFromEntity(expectedPostFixString) }));
    REQUIRE(patternAssignTable.size() == 1);
  }
}
...
TEST_CASE("[TestSimpleParser] Valid if statement - Basic", "[SimpleParser][If]") {
  ...
  REQUIRE(usesSTable.contains({ 1, pkb.getIntRefFromEntity("then") }));
  REQUIRE(usesSTable.contains({ 1, pkb.getIntRefFromEntity("else") }));
  REQUIRE(usesSTable.size() == 2);
  REQUIRE(modifiesSTable.contains({ 2, pkb.getIntRefFromEntity("x") }));
  REQUIRE(modifiesSTable.contains({ 3, pkb.getIntRefFromEntity("y") }));
  REQUIRE(modifiesSTable.size() == 2);
  ...
  REQUIRE(patternAssignTable.contains({ 2, pkb.getIntRefFromEntity("x"), pkb.getIntRefFromEntity(expectedPostFixString) }));
  REQUIRE(patternAssignTable.size() == 1);
  ...
  SECTION("With DE relations") {
    ...
    REQUIRE(modifiesSTable.contains({ 1, pkb.getIntRefFromEntity("x") }));
    REQUIRE(modifiesSTable.contains({ 1, pkb.getIntRefFromEntity("y") }));
    ...
    SECTION("Advanced SPA relations") {
      ...
      REQUIRE(patternIfTable.contains({ 1, pkb.getIntRefFromEntity("then") }));
      REQUIRE(patternIfTable.contains({ 1, pkb.getIntRefFromEntity("else") }));
...
TEST_CASE("[TestSimpleParser] Valid if statement - Singly nested if", "[SimpleParser][If]") {
  ...
  REQUIRE(usesSTable.contains({ 1, pkb.getIntRefFromEntity("then") }));
  REQUIRE(usesSTable.contains({ 1, pkb.getIntRefFromEntity("else") }));
  REQUIRE(usesSTable.contains({ 2, pkb.getIntRefFromEntity("else") }));
  REQUIRE(usesSTable.contains({ 2, pkb.getIntRefFromEntity("while") }));
  REQUIRE(usesSTable.contains({ 3, pkb.getIntRefFromEntity("x") }));
  REQUIRE(usesSTable.contains({ 5, pkb.getIntRefFromEntity("if") }));
  REQUIRE(usesSTable.contains({ 5, pkb.getIntRefFromEntity("read") }));
  REQUIRE(usesSTable.contains({ 6, pkb.getIntRefFromEntity("x") }));
  REQUIRE(usesSTable.contains({ 7, pkb.getIntRefFromEntity("y") }));
  REQUIRE(usesSTable.size() == 9);
  REQUIRE(modifiesSTable.contains({ 4, pkb.getIntRefFromEntity("x") }));
  REQUIRE(modifiesSTable.contains({ 6, pkb.getIntRefFromEntity("y") }));
  REQUIRE(modifiesSTable.contains({ 7, pkb.getIntRefFromEntity("x") }));
  REQUIRE(modifiesSTable.size() == 3);
  REQUIRE(followsTable.size() == 0);
  REQUIRE(parentTable.contains({ 1, 2 }));
  ...
  REQUIRE(patternAssignTable.contains({ 6, pkb.getIntRefFromEntity("y"), pkb.getIntRefFromEntity(expectedPostFixString1) }));
  REQUIRE(patternAssignTable.contains({ 7, pkb.getIntRefFromEntity("x"), pkb.getIntRefFromEntity(expectedPostFixString2) }));
  REQUIRE(patternAssignTable.size() == 2);
  ...
  SECTION("With DE relations") {
    ...
    REQUIRE(modifiesSTable.contains({ 1, pkb.getIntRefFromEntity("y") }));
    REQUIRE(modifiesSTable.contains({ 2, pkb.getIntRefFromEntity("x") }));
    REQUIRE(modifiesSTable.contains({ 5, pkb.getIntRefFromEntity("x") }));
    REQUIRE(modifiesSTable.contains({ 5, pkb.getIntRefFromEntity("y") }));
    ...
    REQUIRE(usesSTable.contains({ 1, pkb.getIntRefFromEntity("while") }));
    REQUIRE(usesSTable.contains({ 1, pkb.getIntRefFromEntity("x") }));
    REQUIRE(usesSTable.contains({ 1, pkb.getIntRefFromEntity("if") }));
    REQUIRE(usesSTable.contains({ 1, pkb.getIntRefFromEntity("read") }));
    REQUIRE(usesSTable.contains({ 1, pkb.getIntRefFromEntity("y") }));
    REQUIRE(usesSTable.contains({ 2, pkb.getIntRefFromEntity("x") }));
    REQUIRE(usesSTable.contains({ 5, pkb.getIntRefFromEntity("x") }));
    REQUIRE(usesSTable.contains({ 5, pkb.getIntRefFromEntity("y") }));
    ...
    SECTION("Advanced SPA relations") {
      ...
      REQUIRE(patternIfTable.contains({ 1, pkb.getIntRefFromEntity("then") }));
      REQUIRE(patternIfTable.contains({ 1, pkb.getIntRefFromEntity("else") }));
      REQUIRE(patternIfTable.contains({ 2, pkb.getIntRefFromEntity("else") }));
      REQUIRE(patternIfTable.contains({ 2, pkb.getIntRefFromEntity("while") }));
      REQUIRE(patternIfTable.contains({ 5, pkb.getIntRefFromEntity("if") }));
      REQUIRE(patternIfTable.contains({ 5, pkb.getIntRefFromEntity("read") }));
...
TEST_CASE("[TestSimpleParser] Valid if statement - Doubly nested if", "[SimpleParser][If]") {
  ...
  REQUIRE(usesSTable.contains({ 2, pkb.getIntRefFromEntity("y1") }));
  REQUIRE(usesSTable.contains({ 3, pkb.getIntRefFromEntity("while") }));
  REQUIRE(usesSTable.contains({ 5, pkb.getIntRefFromEntity("x") }));
  REQUIRE(usesSTable.contains({ 7, pkb.getIntRefFromEntity("b") }));
  REQUIRE(usesSTable.contains({ 9, pkb.getIntRefFromEntity("f") }));
  REQUIRE(usesSTable.contains({ 9, pkb.getIntRefFromEntity("g") }));
  REQUIRE(usesSTable.size() == 6);
  REQUIRE(modifiesSTable.contains({ 2, pkb.getIntRefFromEntity("x1") }));
  REQUIRE(modifiesSTable.contains({ 4, pkb.getIntRefFromEntity("x") }));
  REQUIRE(modifiesSTable.contains({ 6, pkb.getIntRefFromEntity("z") }));
  REQUIRE(modifiesSTable.contains({ 8, pkb.getIntRefFromEntity("z") }));
  REQUIRE(modifiesSTable.contains({ 9, pkb.getIntRefFromEntity("c") }));
  REQUIRE(modifiesSTable.contains({ 10, pkb.getIntRefFromEntity("d") }));
  REQUIRE(modifiesSTable.size() == 6);
  ...
  REQUIRE(patternAssignTable.contains({ 2, pkb.getIntRefFromEntity("x1"), pkb.getIntRefFromEntity(expectedPostFixString1) }));
  REQUIRE(patternAssignTable.contains({ 6, pkb.getIntRefFromEntity("z"), pkb.getIntRefFromEntity(expectedPostFixString2) }));
  REQUIRE(patternAssignTable.contains({ 8, pkb.getIntRefFromEntity("z"), pkb.getIntRefFromEntity(expectedPostFixString3) }));
  REQUIRE(patternAssignTable.contains({ 9, pkb.getIntRefFromEntity("c"), pkb.getIntRefFromEntity(expectedPostFixString4) }));
  ...
  SECTION("With DE relations") {
    ...
    REQUIRE(modifiesSTable.contains({ 1, pkb.getIntRefFromEntity("x1") }));
    REQUIRE(modifiesSTable.contains({ 1, pkb.getIntRefFromEntity("x") }));
    REQUIRE(modifiesSTable.contains({ 1, pkb.getIntRefFromEntity("z") }));
    REQUIRE(modifiesSTable.contains({ 1, pkb.getIntRefFromEntity("c") }));
    REQUIRE(modifiesSTable.contains({ 1, pkb.getIntRefFromEntity("d") }));
    REQUIRE(modifiesSTable.contains({ 3, pkb.getIntRefFromEntity("x") }));
    REQUIRE(modifiesSTable.contains({ 3, pkb.getIntRefFromEntity("z") }));
    REQUIRE(modifiesSTable.contains({ 3, pkb.getIntRefFromEntity("c") }));
    REQUIRE(modifiesSTable.contains({ 3, pkb.getIntRefFromEntity("d") }));
    REQUIRE(modifiesSTable.contains({ 7, pkb.getIntRefFromEntity("z") }));
    REQUIRE(modifiesSTable.contains({ 7, pkb.getIntRefFromEntity("c") }));
    REQUIRE(modifiesSTable.contains({ 7, pkb.getIntRefFromEntity("d") }));
    ...
    REQUIRE(usesSTable.contains({ 1, pkb.getIntRefFromEntity("y1") }));
    REQUIRE(usesSTable.contains({ 1, pkb.getIntRefFromEntity("while") }));
    REQUIRE(usesSTable.contains({ 1, pkb.getIntRefFromEntity("x") }));
    REQUIRE(usesSTable.contains({ 1, pkb.getIntRefFromEntity("b") }));
    REQUIRE(usesSTable.contains({ 1, pkb.getIntRefFromEntity("f") }));
    REQUIRE(usesSTable.contains({ 1, pkb.getIntRefFromEntity("g") }));
    REQUIRE(usesSTable.contains({ 3, pkb.getIntRefFromEntity("x") }));
    REQUIRE(usesSTable.contains({ 3, pkb.getIntRefFromEntity("b") }));
    REQUIRE(usesSTable.contains({ 3, pkb.getIntRefFromEntity("f") }));
    REQUIRE(usesSTable.contains({ 3, pkb.getIntRefFromEntity("g") }));
    REQUIRE(usesSTable.contains({ 7, pkb.getIntRefFromEntity("f") }));
    REQUIRE(usesSTable.contains({ 7, pkb.getIntRefFromEntity("g") }));
    ...
    SECTION("Advanced SPA relations") {
      ...
      REQUIRE(patternIfTable.contains({ 3, pkb.getIntRefFromEntity("while") }));
      REQUIRE(patternIfTable.contains({ 7, pkb.getIntRefFromEntity("b") }));
      REQUIRE(patternIfTable.size() == 2);
      REQUIRE(patternWhileTable.size() == 0);
...
TEST_CASE("[TestSimpleParser] Valid while statement - Basic", "[SimpleParser][While]") {
  ...
  REQUIRE(usesSTable.contains({ 1, pkb.getIntRefFromEntity("else") }));
  REQUIRE(usesSTable.contains({ 1, pkb.getIntRefFromEntity("while") }));
  REQUIRE(usesSTable.contains({ 3, pkb.getIntRefFromEntity("print") }));
  REQUIRE(usesSTable.size() == 4);
  REQUIRE(modifiesSTable.contains({ 2, pkb.getIntRefFromEntity("read") }));
  REQUIRE(modifiesSTable.size() == 1);
  ...
  SECTION("With DE relations") {
    ...
    REQUIRE(modifiesSTable.contains({ 1, pkb.getIntRefFromEntity("read") }));
    REQUIRE(modifiesSTable.size() == 2);
    ...
    SECTION("Advanced SPA relations") {
      ...
      REQUIRE(patternWhileTable.contains({ 1, pkb.getIntRefFromEntity("if") }));
      REQUIRE(patternWhileTable.contains({ 1, pkb.getIntRefFromEntity("else") }));
      REQUIRE(patternWhileTable.contains({ 1, pkb.getIntRefFromEntity("while") }));
...
TEST_CASE("[TestSimpleParser] Valid while statement - Singly nested while", "[SimpleParser][While]") {
  ...
  REQUIRE(usesSTable.contains({ 2, pkb.getIntRefFromEntity("while") }));
  REQUIRE(usesSTable.contains({ 3, pkb.getIntRefFromEntity("while") }));
  REQUIRE(usesSTable.contains({ 3, pkb.getIntRefFromEntity("i") }));
  REQUIRE(usesSTable.contains({ 4, pkb.getIntRefFromEntity("i") }));
  REQUIRE(usesSTable.contains({ 5, pkb.getIntRefFromEntity("i") }));
  REQUIRE(usesSTable.contains({ 6, pkb.getIntRefFromEntity("while") }));
  REQUIRE(usesSTable.size() == 6);
  REQUIRE(modifiesSTable.contains({ 1, pkb.getIntRefFromEntity("while") }));
  REQUIRE(modifiesSTable.contains({ 4, pkb.getIntRefFromEntity("i") }));
  REQUIRE(modifiesSTable.size() == 2);
  REQUIRE(followsTable.contains({ 1, 2 }));
  ...
  REQUIRE(patternAssignTable.contains({ 4, pkb.getIntRefFromEntity("i"), pkb.getIntRefFromEntity(expectedPostFixString) }));
  REQUIRE(patternAssignTable.size() == 1);
  ...
  SECTION("With DE relations") {
    ...
    REQUIRE(modifiesSTable.contains({ 2, pkb.getIntRefFromEntity("i") }));
    REQUIRE(modifiesSTable.contains({ 3, pkb.getIntRefFromEntity("i") }));
    REQUIRE(modifiesSTable.size() == 4);
    REQUIRE(parentTTable.contains({ 2, 4 }));
    REQUIRE(parentTTable.size() == 4);
    REQUIRE(usesSTable.contains({ 2, pkb.getIntRefFromEntity("i") }));
    ...
    SECTION("Advanced SPA relations") {
      ...
      REQUIRE(nextTTable.size() == 25);
      REQUIRE(patternIfTable.size() == 0);
      REQUIRE(patternWhileTable.contains({ 2, pkb.getIntRefFromEntity("while") }));
      REQUIRE(patternWhileTable.contains({ 3, pkb.getIntRefFromEntity("i") }));
      REQUIRE(patternWhileTable.contains({ 3, pkb.getIntRefFromEntity("while") }));
      REQUIRE(patternWhileTable.size() == 3);
...
TEST_CASE("[TestSimpleParser] Valid while statement - Doubly nested while", "[SimpleParser][While]") {
  ...
  REQUIRE(usesSTable.contains({ 1, pkb.getIntRefFromEntity("a") }));
  REQUIRE(usesSTable.contains({ 1, pkb.getIntRefFromEntity("b") }));
  REQUIRE(usesSTable.contains({ 2, pkb.getIntRefFromEntity("print") }));
  REQUIRE(usesSTable.contains({ 3, pkb.getIntRefFromEntity("c") }));
  REQUIRE(usesSTable.contains({ 3, pkb.getIntRefFromEntity("d") }));
  REQUIRE(usesSTable.contains({ 4, pkb.getIntRefFromEntity("e") }));
  REQUIRE(usesSTable.contains({ 4, pkb.getIntRefFromEntity("f") }));
  REQUIRE(usesSTable.contains({ 5, pkb.getIntRefFromEntity("read") }));
  REQUIRE(usesSTable.contains({ 6, pkb.getIntRefFromEntity("if") }));
  REQUIRE(usesSTable.contains({ 7, pkb.getIntRefFromEntity("while") }));
  REQUIRE(usesSTable.contains({ 8, pkb.getIntRefFromEntity("call") }));
  REQUIRE(usesSTable.size() == 11);
  REQUIRE(modifiesSTable.contains({ 2, pkb.getIntRefFromEntity("print") }));
  REQUIRE(modifiesSTable.contains({ 5, pkb.getIntRefFromEntity("read") }));
  REQUIRE(modifiesSTable.contains({ 6, pkb.getIntRefFromEntity("if") }));
  REQUIRE(modifiesSTable.contains({ 7, pkb.getIntRefFromEntity("while") }));
  REQUIRE(modifiesSTable.contains({ 8, pkb.getIntRefFromEntity("call") }));
  ...
  REQUIRE(parentTable.size() == 6);
  REQUIRE(patternAssignTable.contains({ 2, pkb.getIntRefFromEntity("print"), pkb.getIntRefFromEntity(expectedPostFixString1) }));
  REQUIRE(patternAssignTable.contains({ 5, pkb.getIntRefFromEntity("read"), pkb.getIntRefFromEntity(expectedPostFixString2) }));
  REQUIRE(patternAssignTable.contains({ 6, pkb.getIntRefFromEntity("if"), pkb.getIntRefFromEntity(expectedPostFixString3) }));
  REQUIRE(patternAssignTable.contains({ 7, pkb.getIntRefFromEntity("while"), pkb.getIntRefFromEntity(expectedPostFixString4) }));
  REQUIRE(patternAssignTable.contains({ 8, pkb.getIntRefFromEntity("call"), pkb.getIntRefFromEntity(expectedPostFixString5) }));
  ...
  SECTION("With DE relations") {
    ...
    REQUIRE(modifiesSTable.contains({ 1, pkb.getIntRefFromEntity("print") }));
    REQUIRE(modifiesSTable.contains({ 1, pkb.getIntRefFromEntity("read") }));
    REQUIRE(modifiesSTable.contains({ 1, pkb.getIntRefFromEntity("if") }));
    REQUIRE(modifiesSTable.contains({ 1, pkb.getIntRefFromEntity("while") }));
    REQUIRE(modifiesSTable.contains({ 3, pkb.getIntRefFromEntity("read") }));
    REQUIRE(modifiesSTable.contains({ 3, pkb.getIntRefFromEntity("if") }));
    REQUIRE(modifiesSTable.contains({ 4, pkb.getIntRefFromEntity("read") }));
    ...
    REQUIRE(parentTTable.size() == 10);
    REQUIRE(usesSTable.contains({ 1, pkb.getIntRefFromEntity("print") }));
    REQUIRE(usesSTable.contains({ 1, pkb.getIntRefFromEntity("c") }));
    REQUIRE(usesSTable.contains({ 1, pkb.getIntRefFromEntity("d") }));
    REQUIRE(usesSTable.contains({ 1, pkb.getIntRefFromEntity("e") }));
    REQUIRE(usesSTable.contains({ 1, pkb.getIntRefFromEntity("f") }));
    ...
    REQUIRE(usesSTable.contains({ 1, pkb.getIntRefFromEntity("if") }));
    REQUIRE(usesSTable.contains({ 1, pkb.getIntRefFromEntity("while") }));
    REQUIRE(usesSTable.contains({ 3, pkb.getIntRefFromEntity("e") }));
    REQUIRE(usesSTable.contains({ 3, pkb.getIntRefFromEntity("f") }));
    REQUIRE(usesSTable.contains({ 3, pkb.getIntRefFromEntity("read") }));
    REQUIRE(usesSTable.contains({ 3, pkb.getIntRefFromEntity("if") }));
    REQUIRE(usesSTable.contains({ 4, pkb.getIntRefFromEntity("read") }));
    ...
    SECTION("Advanced SPA relations") {
      ...
      REQUIRE(patternIfTable.size() == 0);
      REQUIRE(patternWhileTable.contains({ 1, pkb.getIntRefFromEntity("a") }));
      REQUIRE(patternWhileTable.contains({ 1, pkb.getIntRefFromEntity("b") }));
      REQUIRE(patternWhileTable.contains({ 3, pkb.getIntRefFromEntity("c") }));
      REQUIRE(patternWhileTable.contains({ 3, pkb.getIntRefFromEntity("d") }));
      REQUIRE(patternWhileTable.contains({ 4, pkb.getIntRefFromEntity("e") }));
      REQUIRE(patternWhileTable.contains({ 4, pkb.getIntRefFromEntity("f") }));
...
TEST_CASE("[TestSimpleParser] Loops - Nested/follows if/while loops", "[SimpleParser][Assign][If][Print][Read][While]") {
  ...
  REQUIRE(usesSTable.contains({ 2, pkb.getIntRefFromEntity("D33z") }));
  REQUIRE(usesSTable.contains({ 4, pkb.getIntRefFromEntity("life") }));
  REQUIRE(usesSTable.contains({ 4, pkb.getIntRefFromEntity("bad") }));
  REQUIRE(usesSTable.contains({ 5, pkb.getIntRefFromEntity("read") }));
  REQUIRE(usesSTable.contains({ 6, pkb.getIntRefFromEntity("D33z") }));
  REQUIRE(usesSTable.contains({ 6, pkb.getIntRefFromEntity("life") }));
  REQUIRE(usesSTable.contains({ 7, pkb.getIntRefFromEntity("life") }));
  REQUIRE(usesSTable.contains({ 8, pkb.getIntRefFromEntity("bad") }));
  REQUIRE(usesSTable.contains({ 9, pkb.getIntRefFromEntity("nu7z") }));
  REQUIRE(usesSTable.size() == 9);
  REQUIRE(modifiesSTable.contains({ 1, pkb.getIntRefFromEntity("D33z") }));
  REQUIRE(modifiesSTable.contains({ 3, pkb.getIntRefFromEntity("life") }));
  REQUIRE(modifiesSTable.contains({ 5, pkb.getIntRefFromEntity("print") }));
  REQUIRE(modifiesSTable.contains({ 7, pkb.getIntRefFromEntity("D33z") }));
  REQUIRE(modifiesSTable.size() == 4);
  REQUIRE(followsTable.contains({ 1, 2 }));
  ...
  REQUIRE(patternAssignTable.contains({ 3, pkb.getIntRefFromEntity("life"), pkb.getIntRefFromEntity(expectedPostFixString1) }));
  REQUIRE(patternAssignTable.contains({ 5, pkb.getIntRefFromEntity("print"), pkb.getIntRefFromEntity(expectedPostFixString2) }));
  REQUIRE(patternAssignTable.contains({ 7, pkb.getIntRefFromEntity("D33z"), pkb.getIntRefFromEntity(expectedPostFixString3) }));
  ...
  SECTION("With DE relations") {
    ...
    REQUIRE(followsTTable.size() == 4);
    REQUIRE(modifiesSTable.contains({ 2, pkb.getIntRefFromEntity("life") }));
    REQUIRE(modifiesSTable.contains({ 2, pkb.getIntRefFromEntity("print") }));
    REQUIRE(modifiesSTable.contains({ 2, pkb.getIntRefFromEntity("D33z") }));
    REQUIRE(modifiesSTable.contains({ 4, pkb.getIntRefFromEntity("print") }));
    REQUIRE(modifiesSTable.contains({ 4, pkb.getIntRefFromEntity("D33z") }));
    REQUIRE(modifiesSTable.contains({ 6, pkb.getIntRefFromEntity("D33z") }));
    ...
    REQUIRE(usesSTable.contains({ 2, pkb.getIntRefFromEntity("life") }));
    REQUIRE(usesSTable.contains({ 2, pkb.getIntRefFromEntity("bad") }));
    REQUIRE(usesSTable.contains({ 2, pkb.getIntRefFromEntity("read") }));
    REQUIRE(usesSTable.contains({ 2, pkb.getIntRefFromEntity("nu7z") }));
    REQUIRE(usesSTable.contains({ 4, pkb.getIntRefFromEntity("read") }));
    REQUIRE(usesSTable.contains({ 4, pkb.getIntRefFromEntity("D33z") }));
    REQUIRE(usesSTable.contains({ 8, pkb.getIntRefFromEntity("nu7z") }));
    ...
    SECTION("Advanced SPA relations") {
      ...
      REQUIRE(patternIfTable.contains({ 4, pkb.getIntRefFromEntity("life") }));
      REQUIRE(patternIfTable.contains({ 4, pkb.getIntRefFromEntity("bad") }));
      REQUIRE(patternIfTable.size() == 2);
      REQUIRE(patternWhileTable.contains({ 2, pkb.getIntRefFromEntity("D33z") }));
      REQUIRE(patternWhileTable.contains({ 6, pkb.getIntRefFromEntity("D33z") }));
      REQUIRE(patternWhileTable.contains({ 6, pkb.getIntRefFromEntity("life") }));
      REQUIRE(patternWhileTable.contains({ 8, pkb.getIntRefFromEntity("bad") }));
...
TEST_CASE("[TestSimpleParser] Loops - Random example", "[SimpleParser][Assign][If][Print][Read][While]") {
  ...
  REQUIRE(usesSTable.contains({ 1, pkb.getIntRefFromEntity("if") }));
  REQUIRE(usesSTable.contains({ 1, pkb.getIntRefFromEntity("else") }));
  REQUIRE(usesSTable.contains({ 2, pkb.getIntRefFromEntity("if") }));
  REQUIRE(usesSTable.contains({ 2, pkb.getIntRefFromEntity("then") }));
  REQUIRE(usesSTable.contains({ 2, pkb.getIntRefFromEntity("print") }));
  REQUIRE(usesSTable.contains({ 2, pkb.getIntRefFromEntity("while") }));
  REQUIRE(usesSTable.contains({ 4, pkb.getIntRefFromEntity("print") }));
  REQUIRE(usesSTable.contains({ 4, pkb.getIntRefFromEntity("call") }));
  REQUIRE(usesSTable.contains({ 4, pkb.getIntRefFromEntity("read") }));
  REQUIRE(usesSTable.contains({ 4, pkb.getIntRefFromEntity("else") }));
  REQUIRE(usesSTable.contains({ 5, pkb.getIntRefFromEntity("call") }));
  REQUIRE(usesSTable.contains({ 5, pkb.getIntRefFromEntity("procedure") }));
  ...
  REQUIRE(patternAssignTable.contains({ 5, pkb.getIntRefFromEntity("print"), pkb.getIntRefFromEntity(expectedPostFixString) }));
  REQUIRE(patternAssignTable.size() == 1);
  ...
  SECTION("With DE relations") {
    ...
    REQUIRE(usesSTable.contains({ 1, pkb.getIntRefFromEntity("then") }));
    REQUIRE(usesSTable.contains({ 1, pkb.getIntRefFromEntity("call") }));
    REQUIRE(usesSTable.contains({ 1, pkb.getIntRefFromEntity("procedure") }));
    REQUIRE(usesSTable.contains({ 2, pkb.getIntRefFromEntity("call") }));
    REQUIRE(usesSTable.contains({ 2, pkb.getIntRefFromEntity("read") }));
    REQUIRE(usesSTable.contains({ 2, pkb.getIntRefFromEntity("else") }));
    REQUIRE(usesSTable.contains({ 2, pkb.getIntRefFromEntity("procedure") }));
    REQUIRE(usesSTable.contains({ 4, pkb.getIntRefFromEntity("procedure") }));
    ...
    SECTION("Advanced SPA relations") {
      ...
      REQUIRE(nextTTable.contains({ 5, 5 }));
      REQUIRE(nextTTable.size() == 25);
      REQUIRE(patternIfTable.contains({ 2, pkb.getIntRefFromEntity("if") }));
      REQUIRE(patternIfTable.contains({ 2, pkb.getIntRefFromEntity("then") }));
      REQUIRE(patternIfTable.contains({ 2, pkb.getIntRefFromEntity("print") }));
      REQUIRE(patternIfTable.contains({ 2, pkb.getIntRefFromEntity("while") }));
      REQUIRE(patternIfTable.size() == 4);
      REQUIRE(patternWhileTable.contains({ 1, pkb.getIntRefFromEntity("while") }));
      REQUIRE(patternWhileTable.contains({ 1, pkb.getIntRefFromEntity("print") }));
      REQUIRE(patternWhileTable.contains({ 1, pkb.getIntRefFromEntity("read") }));
      REQUIRE(patternWhileTable.contains({ 1, pkb.getIntRefFromEntity("if") }));
      REQUIRE(patternWhileTable.contains({ 1, pkb.getIntRefFromEntity("else") }));
      REQUIRE(patternWhileTable.contains({ 4, pkb.getIntRefFromEntity("print") }));
      REQUIRE(patternWhileTable.contains({ 4, pkb.getIntRefFromEntity("call") }));
      REQUIRE(patternWhileTable.contains({ 4, pkb.getIntRefFromEntity("read") }));
      REQUIRE(patternWhileTable.contains({ 4, pkb.getIntRefFromEntity("else") }));
